/**
 * Shared Student theme + nav builder.
 * Dark navy theme matching the Benkyou LMS design system.
 */
export const STU_THEME = {
  sidebar: "#0b1929",
  primary: "#185fa5",
  accent: "#5b9bd5",
  navLabel: "#4a7aa8",
...
const ALL_ITEMS = [
  { group: "Learning", label: "Dashboard", path: "/student/dashboard" },
  { group: "Learning", label: "My Courses", path: "/student/courses" },
  { group: "Assessments", label: "Quizzes", path: "/student/assessments" },
  { group: "Assessments", label: "My Scores", path: "/student/grades" },
  { group: "Account", label: "My Profile", path: "/student/profile" },
];
...
export const STU_STYLES = {
  ...
  twoCol: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(380px, 1fr))", gap: 20, marginBottom: 24 },
  progressBg: { width: "100%", height: 6, background: "#1a2d45", borderRadius: 3, overflow: "hidden" },
